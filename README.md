<p align="center">
  <img src="docs/assets/logo.png" width="120" alt="Sha Builder logo" />
</p>
...
Download the latest `ShaBuilder.zip` from the [Releases page](https://github.com/mshariqq/Sha-Builder/releases) and upload it directly via **WordPress Admin > Plugins > Add New > Upload Plugin**. No manual extracting or re-zipping needed.
...
View the project landing page at [https://mshariqq.github.io/Sha-Builder/](https://mshariqq.github.io/Sha-Builder/).
...
Contributions are welcome! Please read [CONTRIBUTING.md](CONTRIBUTING.md) and feel free to open issues and pull requests.
